...
class DataService {
    ...
    /**
     * reads a record as an object.
     * 
     * @param string $table     table name
     * @param string $pk        primary key field name
     * @param int $id           value for the primary key which identifies the record
     * @param array $fields     fields to be read that will be present as attributes of 
     *                          the returned object
     * @return object 
     */
